...
$sth11=$dbh->prepare("CREATE TABLE author(authorname varchar(400), authid int(6) auto_increment, primary key(authid))auto_increment=10001 ENGINE=MyISAM CHARACTER SET utf8mb4 collate utf8mb4_unicode_ci;");
$sth11->execute();
$sth11->finish(); 
