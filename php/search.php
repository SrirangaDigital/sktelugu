...
<main class="cd-main-content">
        <div class="cd-scrolling-bg cd-color-2">
            <div class="cd-container">
                <h1 class="clr1 gapBelow">శోధన</h1>
<?php
...
?>
                <div class="archive_search">
                    <form method="get" action="search-result.php">
                        <table>
                            <tr>
                                <td class="left"><label for="textfield2" class="titlespan">లేఖనములు </label></td>
                                <td class="right"><input name="title" type="text" class="titlespan wide" id="textfield2" maxlength="150"/></td>
                            </tr>
                            <tr>
                                <td class="left"><label for="autocomplete" class="titlespan">రచయితలు</label></td>
...
-->
                            <tr>
                                <td class="left">&nbsp;</td>
                                <td class="right">
                                    <input name="searchform" type="submit" class="clr1 med" id="button_search" value="వెదుకు"/>
                                    <input name="resetform" type="reset" class="clr1 med" id="button_reset" value="రీసెట్"/>
                                </td>
                            </tr>
                        </table>
                    </form>
